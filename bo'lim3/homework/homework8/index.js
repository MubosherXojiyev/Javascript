...
// 1
let index = people.findIndex(person => person.id === 5);
...
// 2
people = people.filter(person => person.lastName.endsWith("va"));


// 3.
people = people.filter(person => person.id !== 4 && person.id !== 9);
